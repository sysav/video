...
Private Function Inserta() As Boolean
     S = "insert into Estaciones(cia,codigo,Descripcion,precio,MediaHora,estado)"
     S = S + " values ('" + CiA + "','" + Text(0).Text + "','" 'El codigo
     S = S + Trim(Text(1).Text) + "'," & Doble(Text(2)) & "," & Doble(Text(3)) & ",0)" 'La descripcion precio
     Inserta = Procesa(S, 1)
End Function
...
Private Function Modifica(Codigo As String) As Boolean
     ...
     S = S + " ,mediaHora=" & Doble(Text(3).Text)
